...
class Weibo(object):
    ...
    def __process_verify_code(pcid):
        ...
        filename = '/Users/mac/PycharmProjects/Python/pin.png'
...
if __name__ == '__main__':
    ...
    if weibo.login():
        ...
        scd = search.CollectData(keyword, startTime, interval)
        while cd.flag:
            print cd.timescope
        ...
        # print >> f, weibo.urlopen('http://weibo.com/kaifulee').read()s